...
public class CaseController {
  ...
  // edit a case
  // here we use case id generated by the database to edit since it is more safer than using the case number but for deleteing we use a custom method to delete the case. 
  ...
  public String editACase(@PathVariable("id") Long caseId, Model model) {
    ...
    model.addAttribute("typeVaribales",casetypeRepos.findAll());   // we add type because when editing we might need to change the case type too.
    return "editcase";
  }
  ...
  // delete a case
  // here a custom method to delete the case is added to clientCaseRepository to delete a case by it's case number.
  ...
  // existingCase.setCourtDate(updatedCase.getCourtDate()); // only update the
  // date
